...
- [설치](user/installation.md)
- [시작하기](user/getting-started.md)
- [기능](user/features/index.md)
  ...
  - [입력기 고정](user/features/input-source-lock.md)
- [설정](user/preferences.md)
- [문제 해결](user/troubleshooting.md)
- [제거](user/uninstall.md)

# 개발자 가이드

- [빌드](dev/building.md)
- [아키텍처](dev/architecture.md)
- [패키징](dev/packaging.md)
- [기여 가이드](dev/contributing.md)
