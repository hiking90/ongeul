...
- **설정 패널** — 메뉴 막대 아이콘에서 레이아웃, 한/영 전환 키, Vim 모드, 입력기 고정을 설정
- **자동 업데이트 확인** — GitHub 릴리스를 확인하여 새 버전 알림. 메뉴 막대에서 수동 확인도 가능

메뉴 막대 아이콘에서 **설정**, **업데이트 확인**, **도움말**에 접근할 수 있습니다. 각 기능의 상세 설명은 [문서 사이트](https://hiking90.github.io/ongeul/dev/user/features/index.html)를 참고하세요.
